...
execute store result score @s automation run data get block ~ ~ ~ Items[8].Count
scoreboard players operation @s automation -= #1 automation
execute store result block ~ ~ ~ Items[8].Count byte 1 run scoreboard players get @s automation
